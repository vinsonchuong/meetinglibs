describe('MeetingLibs.View.Page.NewVisitor', function() {
  var subject;
  beforeEach(function() {
    subject = new MeetingLibs.View.Page.NewVisitor({eventId: '1'});
  });
  ...
  describe('when submitting the form with valid input', function() {
    ...
    it('should create the visitor on the server', function() {
      expect({method: 'POST', url: '/events/1/visitors'}).toHaveBeenRequestedWith({
    ...
    describe('when the server responds', function() {
      beforeEach(function() {
        server.respondTo('POST', '/events/1/visitors', {
          id: 1,
          first_name: 'John', last_name: 'Doe', email: 'jdoe@example.com',
          cas_user: '111', token: ''
        });
